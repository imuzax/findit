...
<!-- Header -->
<div class="mb-10">
<h2 class="font-headline font-bold text-[#0D1B2A] text-3xl tracking-tight mb-3">Welcome back</h2>
<p class="font-body text-on-surface-variant text-base">Please enter your details to sign in.</p>
</div>
<!-- Tabbed Interface (Mocked as active 'Login') -->
<div class="flex gap-8 mb-8 border-b border-outline-variant/30 relative">
<button class="font-label font-semibold text-[#0F7173] text-sm pb-3 relative">
                        Login
                        <div class="absolute bottom-0 left-0 w-full h-[2px] bg-[#0F7173]"></div>
</button>
<button class="font-label font-medium text-on-surface-variant text-sm pb-3 hover:text-on-background transition-colors">
                        Register
                    </button>
</div>
<!-- OAuth Options -->
<div class="flex flex-col gap-4 mb-8">
<button class="w-full flex items-center justify-center gap-3 bg-surface-container-lowest border border-outline-variant/50 hover:bg-surface-container-low transition-colors py-3 rounded-DEFAULT shadow-[0_2px_8px_rgba(13,27,42,0.04)]">
<span class="material-symbols-outlined text-on-background" data-icon="account_circle">account_circle</span>
<span class="font-label font-semibold text-on-background text-sm">Continue with Google</span>
</button>
</div>
<!-- Divider -->
<div class="flex items-center gap-4 mb-8">
<div class="h-[1px] flex-1 bg-outline-variant/30"></div>
<span class="font-label text-xs font-semibold text-on-surface-variant uppercase tracking-wider">Or</span>
<div class="h-[1px] flex-1 bg-outline-variant/30"></div>
</div>
<!-- Login Form -->
<form class="flex flex-col gap-6">
<div class="flex flex-col gap-2">
<label class="font-label font-semibold text-on-background text-sm" for="email">Email Address</label>
<input class="w-full bg-surface-container-lowest border border-outline-variant/50 rounded-DEFAULT px-4 py-3 font-body text-base text-on-background focus:outline-none focus:ring-2 focus:ring-[#0F7173] focus:border-transparent transition-shadow placeholder:text-on-surface-variant/50 shadow-sm" id="email" placeholder="Enter your email" type="email"/>
</div>
<div class="flex flex-col gap-2">
<div class="flex justify-between items-center">
<label class="font-label font-semibold text-on-background text-sm" for="password">Password</label>
<a class="font-label font-medium text-[#0F7173] text-xs hover:underline decoration-[#0F7173] underline-offset-2" href="#">Forgot password?</a>
</div>
<div class="relative">
<input class="w-full bg-surface-container-lowest border border-outline-variant/50 rounded-DEFAULT px-4 py-3 font-body text-base text-on-background focus:outline-none focus:ring-2 focus:ring-[#0F7173] focus:border-transparent transition-shadow placeholder:text-on-surface-variant/50 shadow-sm" id="password" placeholder="••••••••" type="password"/>
<button class="absolute right-3 top-1/2 -translate-y-1/2 text-on-surface-variant hover:text-on-background transition-colors" type="button">
<span class="material-symbols-outlined text-lg" data-icon="visibility_off">visibility_off</span>
</button>
</div>
</div>
<!-- Action Button -->
<button class="w-full bg-[#0D1B2A] text-white font-label font-semibold text-sm py-4 rounded-DEFAULT hover:bg-[#0f1c2c] transition-colors mt-2 shadow-[0_8px_32px_rgba(13,27,42,0.12)]" type="submit">
                        Sign In
                    </button>
</form>
</div>

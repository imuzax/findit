...
<div class="flex justify-between items-center max-w-7xl mx-auto px-8 h-20">
    ...
    <div class="flex items-center gap-4">
        ...
        <a class="bg-[#0D1B2A] text-white hover:bg-[#1a2d42] transition-all duration-200 active:scale-95 duration-150 px-6 py-2.5 rounded-DEFAULT font-['Inter'] font-bold tracking-tight shadow-md" href="post-lost.php">Report Item</a>
    </div>
</div>
</header>

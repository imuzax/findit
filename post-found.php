...
$pageSubtitle = 'Help reunite an item with its rightful owner. Please be descriptive but keep some details private for verification.';
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div class="space-y-2 md:col-span-2">
        <label class="block text-sm font-semibold text-primary" for="location">Found At <span class="text-error">*</span></label>
